...
void nts::Component4069::simulate(std::size_t tick)
{
    ...
    m_pinMap[4].m_state = !m_pinMap[3].m_state;
    m_pinMap[6].m_state = !m_pinMap[5].m_state;
    m_pinMap[8].m_state = !m_pinMap[9].m_state;
    m_pinMap[10].m_state = !m_pinMap[11].m_state;
    m_pinMap[12].m_state = !m_pinMap[13].m_state;
}